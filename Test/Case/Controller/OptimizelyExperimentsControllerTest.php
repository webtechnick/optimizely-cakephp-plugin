<?php
App::uses('OptimizelyExperimentsController', 'Optimizely.Controller');
App::uses('BaseTest', 'Test/Case');

/**
 * OptimizelyExperimentsController Test Case
 *
 */
class OptimizelyExperimentsControllerTest extends BaseTest {
